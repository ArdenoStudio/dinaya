...
export const manageBookingsGuide: DocsGuide = {
  ...
  steps: [
    ...
    },
    {
      ...
      visual: { type: "mockup", mockupId: "dashboard-bookings" },
      hotspots: [{ x: 78, y: 65, label: "Cancel", showCursor: true }],
    },
    {
      ...
      visual: { type: "mockup", mockupId: "dashboard-bookings" },
      hotspots: [{ x: 78, y: 72, label: "Refund", showCursor: true }],
    },
  ],
};
