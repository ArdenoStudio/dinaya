...
export const shareBookingLinkGuide: DocsGuide = {
  ...
  steps: [
    ...
    },
    {
      ...
      visual: { type: "mockup", mockupId: "dashboard-marketing" },
      hotspots: [{ x: 62, y: 58, label: "WhatsApp share", showCursor: true }],
    },
    {
      title: "QR code",
      ...
      visual: { type: "mockup", mockupId: "dashboard-marketing" },
      hotspots: [{ x: 52, y: 58, label: "QR code", showCursor: true }],
    },
    {
      ...
      visual: { type: "mockup", mockupId: "dashboard-marketing" },
      hotspots: [{ x: 58, y: 72, label: "Embed code", showCursor: true }],
    },
  ],
};
