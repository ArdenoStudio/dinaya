...
describe("POST /api/dashboard/deals/publish-suggestion", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe("POST", () => {
    it("returns 401 when auth fails", async () => {
      ...
      const req = new NextRequest("http://localhost/api/dashboard/deals/publish-suggestion", { method: "POST", body: "{}", headers: { "content-type": "application/json" } });
