...
describe("PATCH /api/dashboard/deals/[id]", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe("PATCH", () => {
    it("returns 401 when auth fails", async () => {
      ...
      const req = new NextRequest("http://localhost/api/dashboard/deals/[id]", { method: "PATCH", body: "{}", headers: { "content-type": "application/json" } });
