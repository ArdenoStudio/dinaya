...
describe("POST /api/dashboard/reviews/[id]/generate-reply", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe("POST", () => {
    it("returns 401 when auth fails", async () => {
      ...
      const req = new NextRequest("http://localhost/api/dashboard/reviews/[id]/generate-reply", { method: "POST", body: "{}", headers: { "content-type": "application/json" } });
