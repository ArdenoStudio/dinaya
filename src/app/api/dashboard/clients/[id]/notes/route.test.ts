...
describe("POST /api/dashboard/clients/[id]/notes", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe("POST", () => {
    it("returns 401 when auth fails", async () => {
      ...
      const req = new NextRequest("http://localhost/api/dashboard/clients/[id]/notes", { method: "POST", body: "{}", headers: { "content-type": "application/json" } });
