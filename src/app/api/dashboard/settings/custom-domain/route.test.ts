...
describe("PATCH /api/dashboard/settings/custom-domain", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe("PATCH", () => {
    it("returns 401 when auth fails", async () => {
      ...
      const req = new NextRequest("http://localhost/api/dashboard/settings/custom-domain", { method: "PATCH", body: "{}", headers: { "content-type": "application/json" } });
