...
describe("POST /api/client/bookings/[token]/cancel", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe("POST", () => {
    it("handles the request", async () => {
      const req = new NextRequest("http://localhost/api/client/bookings/[token]/cancel", { method: "POST", body: "{}", headers: { "content-type": "application/json" } });
