...
import { getAiWorkflowRunDashboardDetail } from "@/lib/dashboard/ai";
...
export async function GET(
  ...
  const detail = await getAiWorkflowRunDashboardDetail(businessId, id);
  if (!detail) {
