  ...
  return (
    <div className="space-y-6">
      ...
      {rolloutOpen ? (
        ...
        <section className="rounded-xl border border-blue-200 bg-blue-50/70 p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
            <span className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-white text-primary ring-1 ring-blue-200">
              <PhoneCall className="size-5" aria-hidden="true" />
            </span>
            <div>
              <div className="inline-flex items-center gap-2 rounded-full bg-white px-2.5 py-1 text-xs font-medium text-primary ring-1 ring-blue-200">
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-blue-950/80">
