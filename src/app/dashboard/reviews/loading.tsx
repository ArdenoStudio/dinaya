  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        {[1, 2, 3].map((i) => (
          <div key={i} className="rounded-2xl border border-border/60 bg-card dark:border-border/60 dark:bg-card p-4 text-center">
      ...
      {/* Table */}
      <div className="rounded-2xl border border-border/60 bg-card dark:border-border/60 dark:bg-card overflow-hidden">
