...
export default function FeaturesPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Pro AI growth */}
      <section className="max-w-6xl mx-auto px-6 pb-20" id="pro-ai">
        <div className="mb-10">
          ...
          <p className="text-muted-foreground max-w-xl">
            Seven AI-powered tools that fill your calendar, win back clients, and keep your social presence active — without adding hours to your week.
          </p>
        </div>
