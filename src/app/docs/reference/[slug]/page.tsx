...
export default async function ReferencePage({ params }: Props) {
  ...
  return (
    <article className="pb-16">
      ...
      <header className="mb-8 rounded-3xl border border-gray-200 dark:border-neutral-800 bg-linear-to-br from-white via-slate-50 to-blue-50/60 px-6 py-6 shadow-xs shadow-gray-900/5 dark:shadow-black/20">
      ...
      <div className="space-y-8">
        {ref.sections.map((s) => (
          <section key={s.heading} className="rounded-2xl border border-gray-200 dark:border-neutral-800 bg-white dark:border-neutral-800 dark:bg-neutral-900 p-5 shadow-xs shadow-gray-900/5 dark:shadow-black/20">
