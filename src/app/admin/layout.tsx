...
export default async function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-muted/20 dark:bg-neutral-950 lg:grid lg:grid-cols-[17rem_minmax(0,1fr)]">
      <aside
        className="hidden border-r bg-white dark:border-neutral-800 dark:bg-neutral-900 lg:flex lg:flex-col"
        ...
        <header className="sticky top-0 z-20 border-b bg-white dark:border-neutral-800 dark:bg-neutral-900/95 dark:border-neutral-800 dark:bg-neutral-950/95 backdrop-blur dark:border-neutral-800 dark:bg-neutral-950/95">
          <div className="flex h-16 items-center gap-3 px-4 sm:px-6 lg:px-8">
            ...
            <details className="group lg:hidden">
              ...
              <div className="absolute left-3 top-14 w-[min(20rem,calc(100vw-1.5rem))] rounded-lg border bg-white dark:border-neutral-800 dark:bg-neutral-900 p-2 shadow-lg">
                <AdminSidebarNav />
              </div>
            </details>
            ...
            <Link
              href="/dashboard"
              className="hidden rounded-md border bg-white dark:border-neutral-800 dark:bg-neutral-900 px-3 py-2 text-xs font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground sm:inline-flex"
            >
