  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        desktopPhase: 3,
        nativeStatus: "fallback",
        summary: "Availability windows, closed days, overrides, and timezone-aware display.",
      },
    ],
  },
  {
    ...
    routes: [
      {
        ...
        nativeStatus: "fallback",
        ownerOnly: true,
        summary: "Review list, reply workflow, AI replies, and rating summary.",
      },
      {
        id: "payments",
        label: "Payments",
        ...
        nativeStatus: "fallback",
        ownerOnly: true,
        summary: "Payment list, status filters, booking detail, and supported refund visibility.",
      },
      {
        id: "marketing",
        label: "Marketing",
        ...
        nativeStatus: "fallback",
        ownerOnly: true,
        summary: "Directory, referral, campaign, and public-growth settings.",
      },
      {
        id: "deals",
        label: "Deals",
        ...
        nativeStatus: "fallback",
        ownerOnly: true,
        summary: "Deal list, status, expiry, demand-aware suggestions, and performance.",
      },
      {
        id: "broadcasts",
        label: "Broadcasts",
        ...
        nativeStatus: "fallback",
        ownerOnly: true,
        summary: "Broadcast list, status, audience summary, and result summary.",
      },
      {
        id: "aiHub",
        label: "AI Hub",
        ...
        nativeStatus: "fallback",
        ownerOnly: true,
        summary: "Compact launcher for supported generated copy, replies, and AI workflows.",
      },
      {
        id: "reports",
        label: "Reports",
        ...
        desktopPhase: 4,
        nativeStatus: "fallback",
        summary: "Overview metrics, date filters, deal analytics, and export actions.",
      },
    ],
  },
  {
    ...
    routes: [
      {
        ...
        nativeStatus: "fallback",
        ownerOnly: true,
        summary: "Connected states, setup status, and advanced provider setup fallback.",
      },
      {
        id: "automations",
        label: "Automations",
        ...
        nativeStatus: "fallback",
        ownerOnly: true,
        summary: "Automation list, enablement state, run status, and history summary.",
      },
      {
        id: "billing",
        label: "Plan & billing",
      ...
      },
      {
        ...
        nativeStatus: "foundation",
        ownerOnly: true,
        summary: "Business profile, booking page settings, notification preferences, and devices.",
      },
    ],
  },
