...
export const dashboardRouteGroups = [
  {
    ...
    routes: [
      ...
      },
      {
        ...
        desktopPhase: 3,
        nativeStatus: "native",
        summary: "Client list, detail, booking history, native editing, notes, stages, and contact actions.",
      },
    ],
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        desktopPhase: 3,
        nativeStatus: "native",
        summary: "Native weekly window edits, blocked/custom date overrides, and timezone-aware availability.",
      },
    ],
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        nativeStatus: "native",
        ownerOnly: true,
        summary: "Native share tools, directory state, social connections, content list, detail, and actions.",
      },
      {
        id: "deals",
        label: "Deals",
      ...
      },
      {
        ...
        nativeStatus: "native",
        ownerOnly: true,
        summary: "Native workflow history, branch AI toggles, content generation, and reactivation launcher.",
      },
      {
        id: "reports",
        label: "Reports",
  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        nativeStatus: "native",
        ownerOnly: true,
        summary: "Native profile, booking policies, public links, desktop devices, current-device revoke, and fallback.",
      },
    ],
  },
