...
export const docsCardSurface =
  "rounded-2xl border border-gray-200/80 bg-white shadow-sm shadow-gray-900/5";

export const docsHeroSurface =
  "rounded-3xl border border-gray-200 bg-gradient-to-br from-white via-slate-50 to-blue-50/60 shadow-sm shadow-gray-900/5";
