          ...
          {listings.map((business) => {
            ...
            return (
              <Link
                key={business.slug}
                href={bookingUrl}
                className="rounded-2xl border bg-white dark:border-neutral-800 dark:bg-neutral-900 p-5 shadow-xs transition-[transform,box-shadow,border-color] duration-150 ease-out hover:border-primary/30 hover:shadow-md active:scale-[0.96] motion-reduce:active:scale-100"
              >
