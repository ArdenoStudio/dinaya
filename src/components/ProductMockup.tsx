...
export default function ProductMockup() {
  ...
  return (
    <section className="max-w-5xl mx-auto px-6 pb-28 relative">
      ...
      <div className="relative" style={{ perspective: "1200px" }}>
        ...
        <button
          onClick={() => navigate(-1)}
          aria-label="Previous"
          className="absolute left-3 sm:-left-14 top-1/2 -translate-y-1/2 z-20 size-10 rounded-full bg-white border border-gray-200 shadow-lg flex items-center justify-center text-gray-400 hover:text-blue-600 hover:border-blue-200 hover:shadow-md transition-all"
        >
        ...
        <button
          onClick={() => navigate(1)}
          aria-label="Next"
          className="absolute right-3 sm:-right-14 top-1/2 -translate-y-1/2 z-20 size-10 rounded-full bg-white border border-gray-200 shadow-lg flex items-center justify-center text-gray-400 hover:text-blue-600 hover:border-blue-200 hover:shadow-md transition-all"
        >
          ...
          >
            ...
            <div className="bg-white p-6 sm:p-8">
              ...
              <div className="flex items-center gap-3 mb-6 pb-5 border-b border-gray-100">
                ...
                <div className="ml-auto hidden sm:flex items-center gap-1.5 text-xs text-green-600 font-medium bg-green-50 px-2.5 py-1 rounded-full border border-green-100/80">
              ...
              <div className="mt-6 pt-5 border-t border-gray-100 flex flex-col sm:flex-row items-center gap-3">
                <button className="w-full sm:flex-1 bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3.5 rounded-xl font-semibold text-sm shadow-lg shadow-blue-500/25 hover:shadow-blue-500/35 transition-all">
