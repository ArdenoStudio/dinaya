    ...
    <div className="w-full h-full flex flex-col bg-[#f2f2f7]">
      ...
      <div className="px-[14px] pb-[26px] pt-[2px]">
        ...
        <div className="flex items-center justify-center gap-[5px] mt-[6px]">
          <span className="text-[11px] text-gray-300">Powered by</span>
          <span className="inline-flex items-center gap-[4px] text-gray-500">
            <svg width={10} height={10} viewBox="255 285 960 920" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
