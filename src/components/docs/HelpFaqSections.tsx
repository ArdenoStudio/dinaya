            ...
            {popularHelpArticles.map((a) => {
              ...
              if (a.guideSlug) {
                return (
                  <Link
                    ...
                    className="group flex items-center gap-3 rounded-xl border bg-white dark:border-neutral-800 dark:bg-neutral-900 p-3.5 hover:border-primary/30 hover:shadow-sm transition-[transform,box-shadow,border-color] duration-150 ease-out active:scale-[0.99] motion-reduce:active:scale-100"
                  >
                    {inner}
                  </Link>
                );
              ...
              return (
                <button
                  ...
                  className="group flex items-center gap-3 rounded-xl border bg-white dark:border-neutral-800 dark:bg-neutral-900 p-3.5 text-left hover:border-primary/30 hover:shadow-sm transition-[transform,box-shadow,border-color] duration-150 ease-out active:scale-[0.99] motion-reduce:active:scale-100 w-full"
                >
                  {inner}
                </button>
              );
