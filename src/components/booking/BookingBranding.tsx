  ...
  return (
    <div className="flex items-center justify-center border-t border-gray-100 bg-white px-4 py-4 md:px-8 md:py-5">
      <Link
        ...
        className="group inline-flex items-center gap-2 rounded-lg px-2 py-1 transition-colors hover:bg-gray-50"
      >
        <span className="text-[11px] text-gray-400 md:text-xs">{copy.poweredBy}</span>
