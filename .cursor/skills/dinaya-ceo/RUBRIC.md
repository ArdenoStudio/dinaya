...
| ID | Criterion | 0 | 1 | 2 |
|----|-----------|---|---|---|
| F1 | Cluster density | Scatters cities/verticals | Weak cluster story | Same Colombo strip + referral map |
| F2 | Beachhead vertical | Off-vertical | Adjacent vertical | Salon/barber/spa/MUA/fitness wedge |
...
| ID | Criterion | 0 | 1 | 2 |
|----|-----------|---|---|---|
| M1 | WhatsApp reality | Replaces WhatsApp pitch | Complement mentioned | "Booking link for WhatsApp" canon |
| M2 | Payments | Stripe/global first | PayHere optional | LKR + PayHere-ready story |
| M3 | Setup | Self-serve only fantasy | Partial concierge | Concierge + 5-min page path |
| M4 | SME pricing | Enterprise/global price | LKR stated | Matches Starter/Pro/Growth tiers |
| M5 | Local competition | Ignores OrderNow/Servio | Named once | Clear wedge vs local players |
...
| W3 | Defensibility | Commodity calendar | Some local setup | PayHere + SL ops + growth workflows |
...
| E4 | Ship path | No verify/migration plan | Partial | `npm run verify` + incremental schema |
...
| B2 | Domain | dinaya.app / wrong TLD | dinaya.lk buried | dinaya.lk anchored |
...
F1 multi-country **P0** · E1 funding spike **P0** · M1 replace WhatsApp **P1** · B1 AI platform hero **P1** · W1 commodity calendar **P1**
