...
| B4 | Plan API gate | UI only | Some routes | requirePro everywhere |
| B5 | PayHere trust | Client amount | Partial verify | Server hash + webhook |
...
| ID | Criterion | 0 | 1 | 2 |
|----|-----------|---|---|---|
| Q1 | npm run verify | Not run | Lint only | Full verify |
