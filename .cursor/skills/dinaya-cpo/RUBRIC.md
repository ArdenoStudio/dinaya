...
| P5 | Beachhead fit | Off-vertical | Adjacent | Salon/barber/spa cluster |
...
| G2 | API enforce | UI only | Partial `requirePro` | API + ProGate |
| G3 | Limits | Ignores WhatsApp/staff caps | Mentioned | Enforced in plan.ts |
...
| S4 | Verify path | Untested | Partial | `npm run verify` planned |
