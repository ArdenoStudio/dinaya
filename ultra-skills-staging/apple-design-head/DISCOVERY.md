...
When reviewing a project that uses Ultra Skills, read `.cursor/skills/_shared/VISUAL.md`, `BRAND.md`, and `PATHS.md` first. Map surfaces from `_shared/PATHS.md` — do not assume any specific repo layout.
...
**Related skills:** `ultra-visual-system`, `ultra-brand-voice`, `ultra-scheduling-engine`, `ultra-hub`
